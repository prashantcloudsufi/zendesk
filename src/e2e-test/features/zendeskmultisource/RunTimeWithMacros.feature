...
Feature: Zendesk Multi Source - Run time scenarios
  ...
  @TS-ZD-MULTI-RNTM_MACRO-01 @BQ_SINK @BQ_MULTI_CLEANUP @FILE_PATH
  ...
  @TS-ZD-MULTI-RNTM_MACRO-02 @BQ_SINK @BQ_MULTI_CLEANUP @FILE_PATH
  ...
  @TS-ZD-MULTI-RNTM-MACRO-03 @BQ_SINK @BQ_SINK_CLEANUP @BQ_MULTI_CLEANUP @FILE_PATH
  ...
  @TS-ZD-RNTM-MACRO-04 @BQ_SINK @BQ_SINK_CLEANUP @BQ_MULTI_CLEANUP
  Scenario: Verify pipeline failure message in logs when user provides invalid Object with Macros
    ...
    Then Open Pipeline logs and verify Log entries having below listed Level and Message:
      | Level | Message                                         |
      | ERROR | invalid.multiobjectstopull.logsmessage          |

  @TS-ZD-MULTI-RNTM-MACRO-05 @BQ_SINK @BQ_SINK_CLEANUP @BQ_MULTI_CLEANUP

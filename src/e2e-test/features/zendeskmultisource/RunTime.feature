...
Feature: Zendesk Multi Source - Run time scenarios
  ...
  Scenario: Verify user should be able to preview the pipeline when plugin is configured for Multiple objects
  ...
  Scenario: Verify user should be able to deploy and Run the pipeline when plugin is configured for Multiple objects
    When Open Datafusion Project to configure pipeline
    And Select data pipeline type as: "Data Pipeline - Batch"
    And Select plugin: "Zendesk Multi Objects" from the plugins list as: "Source"
    And Navigate to the properties page of plugin: "ZendeskMultiObjects"
  ...
  Scenario: Verify user should be able to preview the pipeline when plugin is configured with a Single Object for both Object to Pull and Object to Skip operation
    When Open Datafusion Project to configure pipeline
    And Select data pipeline type as: "Data Pipeline - Batch"
    And Select plugin: "Zendesk Multi Objects" from the plugins list as: "Source"
    And Navigate to the properties page of plugin: "ZendeskMultiObjects"

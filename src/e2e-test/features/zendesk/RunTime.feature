...
Feature: Zendesk Source - Run time scenarios
  ...
  Scenario: Verify user should be able to preview the pipeline when plugin is configured for a Non hierarchical object
  ...
  Scenario: Verify user should be able to deploy and Run the pipeline when plugin is configured for a Non hierarchical object
    When Open Datafusion Project to configure pipeline
    And Select data pipeline type as: "Data Pipeline - Batch"
    And Select plugin: "Zendesk" from the plugins list as: "Source"
    And Navigate to the properties page of plugin: "Zendesk"
  ...
  Scenario: Verify user should be able to preview the pipeline when plugin is configured for a hierarchical object
    When Open Datafusion Project to configure pipeline
    And Select data pipeline type as: "Data Pipeline - Batch"
    And Select plugin: "Zendesk" from the plugins list as: "Source"
    And Navigate to the properties page of plugin: "Zendesk"
  ...
  Scenario: Verify user should be able to deploy and Run the pipeline when plugin is configured for a hierarchical object
    When Open Datafusion Project to configure pipeline
    And Select data pipeline type as: "Data Pipeline - Batch"
    And Select plugin: "Zendesk" from the plugins list as: "Source"
    And Navigate to the properties page of plugin: "Zendesk"
    ...
    And Wait till pipeline is in running state
    And Verify the pipeline status is "Succeeded"
    Then Validate record created in Sink application for Single object is equal to expected output file "ticketCommentsOutputFile"

  @TS-ZD-RNTM-05 @BQ_SINK
  Scenario: Verify user should be able to preview the pipeline when plugin is configured for Advanced properties
    When Open Datafusion Project to configure pipeline
    And Select data pipeline type as: "Data Pipeline - Batch"
    And Select plugin: "Zendesk" from the plugins list as: "Source"
    And Navigate to the properties page of plugin: "Zendesk"
  ...
  Scenario: Verify user should be able to deploy and Run the pipeline when plugin is configured for Advanced Properties
    When Open Datafusion Project to configure pipeline
    And Select data pipeline type as: "Data Pipeline - Batch"
    And Select plugin: "Zendesk" from the plugins list as: "Source"
    And Navigate to the properties page of plugin: "Zendesk"
  ...
  @TS-ZD-RNTM-07
  Scenario: Verify user should be able to preview the pipeline when plugin is configured for a Herarchical object with File Sink
    When Open Datafusion Project to configure pipeline
    And Select data pipeline type as: "Data Pipeline - Batch"
    And Select plugin: "Zendesk" from the plugins list as: "Source"
    And Navigate to the properties page of plugin: "Zendesk"
  ...
  @TS-ZD-RNTM-08 @FILE_SINK_TEST
  Scenario: Verify user should be able to deploy and Run the pipeline when plugin is configured for a herarchical object with File Sink
    When Open Datafusion Project to configure pipeline
    And Select data pipeline type as: "Data Pipeline - Batch"
    And Select plugin: "Zendesk" from the plugins list as: "Source"
    And Navigate to the properties page of plugin: "Zendesk"
